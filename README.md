...
> ⚠️ **DEPRECATED (2026-09-19):** This marketplace has been split into two domain marketplaces and will not receive further updates. For new installs use **[full-aigc-plugins/full-aigc-plugins](https://github.com/full-aigc-plugins/full-aigc-plugins)** (AIGC) and **[full-stack-plugins/full-stack-plugins](https://github.com/full-stack-plugins/full-stack-plugins)** (development process). Existing installs keep working via GitHub redirects — remove the `partme-ai` marketplace and add the two new ones to get future updates.
