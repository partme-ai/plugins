...
> ⚠️ **已弃用（2026-09-19）：** 本市场已拆分为两个领域市场，不再更新。新安装请使用 **[full-aigc-plugins/full-aigc-plugins](https://github.com/full-aigc-plugins/full-aigc-plugins)**（AIGC）与 **[full-stack-plugins/full-stack-plugins](https://github.com/full-stack-plugins/full-stack-plugins)**（研发过程）。已安装的插件经 GitHub 重定向仍可用——如需后续更新，请移除 `partme-ai` 市场并添加两个新市场。
...
| MiniMax 设计 | `minimax-design` | [partme-minimax-design](https://github.com/partme-ai/partme-minimax-design) | 0.4.0 | `assets/logo-approved.png` |
